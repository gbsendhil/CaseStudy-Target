...
public class MainActivity extends AppCompatActivity implements IMainActivity{
    ...
    */
    ...
    public void addToCart(Product product, int quantity) {
        ...
        Set<String> serialNumbers = preferences.getStringSet(PreferenceKeys.shopping_cart, new HashSet<String>());
        serialNumbers.add(String.valueOf(product.getId()));
    ...
    public void removeCartItem(CartItem cartItem){
        ...
        editor.remove(String.valueOf(cartItem.getProduct().getId()));
        editor.commit();
        ...
        if(serialNumbers.size() == 1){
            ...
            serialNumbers.remove(String.valueOf(cartItem.getProduct().getId()));
            editor.putStringSet(PreferenceKeys.shopping_cart, serialNumbers);
            editor.commit();
        }
